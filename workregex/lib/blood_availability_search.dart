...
import 'package:workregex/blood_availability.dart';
...
class _BloodAvailabilitySearchState extends State<BloodAvailabilitySearch> {
  final List<DropDownValueModel> state = const <DropDownValueModel>[
     DropDownValueModel(
  ...
  final List<DropDownValueModel> bloodGroup = const <DropDownValueModel>[
  ...
  final List<DropDownValueModel> bloodComponent = const <DropDownValueModel>[
